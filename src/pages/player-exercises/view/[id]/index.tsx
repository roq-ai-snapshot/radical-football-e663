...
import { getPlayerExerciseById } from 'apiSdk/player-exercises';
...
function PlayerExerciseViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Player Exercise Detail View
          </Text>
          {hasAccess('player_exercise', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/player-exercises/edit/${data?.id}`} passHref legacyBehavior>
              <Button
